...
def magic_impute(
    ...
    if conda_env is not None:
        ...
        # Fit and transform
        print(f"  Running MAGIC diffusion...")
...
def knn_smooth(
    ...
    if use_pca:
        ...
        if hasattr(spatioloji_obj, '_embeddings') and 'X_pca' in spatioloji_obj._embeddings:
            ...
            print(f"  Computing PCA for neighbor finding...")
    ...
    print(f"  ✓ k-NN smoothing complete")
...
def alra_impute(
    ...
    if k is None:
        print(f"  Determining optimal rank...")
        ...
        try:
            ...
            print(f"    SVD failed, using default rank: 20")
            k = 20
    ...
    try:
        ...
        print(f"    Falling back to PCA-based approximation...")
    ...
    print(f"  ✓ ALRA imputation complete")
...
def dca_impute(
    ...
    print(f"  ✓ DCA imputation complete")
...
def compare_imputation_methods(
    ...
    n_test_genes: int = 10,
    methods: List[str] = ['knn_smooth', 'alra'],
    magic_conda_env: Optional[str] = None,  # NEW PARAMETER
    random_state: int = 42
) -> pd.DataFrame:
    """
